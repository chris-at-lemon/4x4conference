...
const Home: NextPage = () => {
  ...
  return (
    <>
      <Hero heroImg="/img/threadmarks.jpg" heroH1="Fonds für jedes Gelände" />
      <section
        id="intro"
        className={`${styles["section--Separator"]} ${styles["section--gray"]} ${styles["no-mt"]}`}
      >
        <TitleSection
          img={Company}
      ...
      <section
        className={`${styles["section--Features"]} ${styles["features--withText"]} ${styles["section--gray"]}`}
      >
      ...
      <section
        id="intro"
        className={`${styles["section--Separator"]} ${styles["no-mt"]}`}
      >
        <TitleSection
          img={Horn}
              ...
              <div className="row">
                <div className="col-md-6">
                  <img
                    ...
                    src="https://ik.imagekit.io/vcqe1lhbs/4x4/business/tr:w-575/office_fJVRStAaO.jpg"
                    alt="office"
                  />
                </div>
                <div className="col-md-6">
                  <p>
                    Im Zusammenspiel der aktuellen Marktlage, den
                    makroökonomischen Herausforderungen und Ihren eigenen Zielen
                    in der Kapitalanlage ist es wahrscheinlich wichtiger denn je
                    sich mit einem gut diversifizierten Portfolio auf jedes
                    Gelände vorzubereiten.
                    <br />
                    <br />
                    Lernen Sie vier einzigartige Manager und deren Strategien
                    persönlich kennen. Nutzen Sie die Chance zum direkten
                    Austausch mit den Portfoliomanagern im attraktiven
                    Workshop-Format (4x10 Teilnehmer für je 30 Min. pro
                    Portfoliomanager im Wechsel).
                    <br />
                    <br />
                    Mit der 4x4-Roadshow bieten wir Ihnen spannende Ansätze, um
                    die von Ihnen verantworteten Portfolios geländegängig zu
                    machen und somit auf die kommenden Herausforderungen
                    einzustellen. Wir freuen uns auf Sie!
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* -- /. Cities Intro --*/}
      <section
        className={`${styles["section--Features"]} ${styles["section--gray"]}`}
      >
        <div className="container">
          <div className="row">
            <div className="col-md-3">
